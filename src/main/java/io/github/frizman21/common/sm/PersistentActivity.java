...
public interface PersistentActivity extends Activity {
   ...
   * thread running the run() function will be terminated upon completion of this function call. 
   * The StateMachine will forcable destroy the thread after this call.
   */  
  public void kill();
}
